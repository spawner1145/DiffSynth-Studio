...
def build_complextro_pipe(
    ...
    complextro_dit_file="/root/autodl-tmp/DiffSynth-Studio/models/Complextro/v1/model-e3-s10059.safetensors",
...
if __name__ == "__main__":
    ...
    prompts = [
        "green lizard creature, seed on back, big eyes, cartoon style, clean background",
        "orange lizard creature, flame tail, smiling, full body, simple background",
        "蓝色乌龟生物，壳纹理清晰，大眼睛，Q版风格，纯色背景",
    ]
